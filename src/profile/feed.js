       ...
       <section class="py-4">
          ...
          <div class="swiper-container w-100 h-100 py-4">
            <div class="swiper-wrapper">
              ...
              {/* <div class="swiper-slide w-auto">
                <div class="avatar avatar-xl"><img class="avatar-img" src="https://i.ibb.co/3TPnWpZ/people-1.jpg" alt="avatar"><span class="avatar-status bg-success"></span></img></div>
              </div>
              <div class="swiper-slide w-auto">
                <div class="avatar avatar-xl"><img class="avatar-img" src="https://i.ibb.co/vqNVTz1/people-2.jpg" alt="avatar"><span class="avatar-status bg-success"></span></img></div>
              </div>
              <div class="swiper-slide w-auto">
                <div class="avatar avatar-xl"><img class="avatar-img" src="https://i.ibb.co/L6ht5pP/people-3.jpg" alt="avatar"><span class="avatar-status bg-success"></span></img></div>
              </div>
              <div class="swiper-slide w-auto">
                <div class="avatar avatar-xl"><img class="avatar-img" src="https://i.ibb.co/qxsCFRL/people-4.jpg" alt="avatar"><span class="avatar-status bg-warning"></span></img></div>
              </div>
              <div class="swiper-slide w-auto">
                <div class="avatar avatar-xl"><img class="avatar-img" src="https://i.ibb.co/0qVzQvw/people-5.jpg" alt="avatar"><span class="avatar-status bg-danger"></span></img></div>
              </div>
              <div class="swiper-slide w-auto">
                <div class="avatar avatar-xl"><img class="avatar-img" src="https://i.ibb.co/3cyp0C9/people-6.jpg" alt="avatar"><span class="avatar-status bg-danger"></span></img></div>
              </div> */}
            </div>
          </div>
        </section>
